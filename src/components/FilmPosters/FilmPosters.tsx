  ...
  return (
    <>
          ...
          <div className={styles["film-poster__content"]}>
            <div className={styles["film-poster__overview"]}>
              ...
              <div className={styles["film-poster__about"]}>
                ...
                <div className={`${styles["film-poster__genres"]} texts`}>
            ...
            <div className={styles["film-poster__information"]}>
              <div className={`${styles["film-poster__fullname"]} texts`}>
            ...
            <div className={`${styles["film-poster__description"]} texts`}>
              {film.description}
            </div>
          </div>
        </div>
      ...
      <div className={styles["film-poster__image"]}>
        ...
        <ImageFilter styles={film.className} />
      </div>
    </>
  );
};
        ...
        {films.map((film) => (
          <SwiperSlide key={film.id}>
            <div className={styles["film-poster__body"]}>
              <div
                className={cn("container", styles["film-poster__container"])}
              >
